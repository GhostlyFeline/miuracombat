...
draw_circle_color(x, y, _radius * 1.00, c_black, c_green, 0);
draw_circle_color(x, y, _radius * 0.66, merge_color(c_green, c_yellow, 0.50), c_black, 0);
draw_circle_color(x, y, _radius * 0.50, merge_color(c_yellow, c_white, 0.50), c_black, 0);
gpu_set_blendmode(bm_normal);
